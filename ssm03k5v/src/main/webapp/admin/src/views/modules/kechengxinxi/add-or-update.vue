  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.xingqi"
                placeholder="星期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="课节" prop="kejie">
          <el-select v-model="ruleForm.kejie" placeholder="请选择课节">
            <el-option
                v-for="(item,index) in kejieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="课节" prop="kejie">
	      <el-input v-model="ruleForm.kejie"
                placeholder="课节" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                        ...
                                        this.kejieOptions = "第一节,第二节,第三节,第四节,第五节,第六节,第七节".split(',')
                                        this.$http({
    ...
    gonghaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
                                                                                                                                                                        if(data.data.jiaoshi){
                this.ruleForm.jiaoshi = data.data.jiaoshi
              }
                              } else {
          this.$message.error(data.msg);
        }
