        ...
        <div v-else>
          <el-form-item v-if="ruleForm.peitu" label="配图" prop="peitu">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.peitu.split(',')" :src="item" width="100" height="100">
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="资源" prop="ziyuan">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.ziyuan" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.ziyuan" label="资源" prop="ziyuan">
                    <span v-html="ruleForm.ziyuan"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
