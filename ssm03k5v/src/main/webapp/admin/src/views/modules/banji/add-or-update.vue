          ...
          <el-form-item class="input" label="班级人数" prop="banjirenshu">
              <el-input v-model="ruleForm.banjirenshu" 
                placeholder="班级人数" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班级导师" prop="banjidaoshi">
          <el-input v-model="ruleForm.banjidaoshi" 
              placeholder="班级导师" clearable  :readonly="ro.banjidaoshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班级导师" prop="banjidaoshi">
              <el-input v-model="ruleForm.banjidaoshi" 
                placeholder="班级导师" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
