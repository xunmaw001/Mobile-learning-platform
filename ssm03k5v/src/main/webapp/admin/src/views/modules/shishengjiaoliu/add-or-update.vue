          ...
          <el-form-item class="input" label="教师" prop="jiaoshi">
              <el-input v-model="ruleForm.jiaoshi" 
                placeholder="教师" readonly></el-input>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="学生留言" prop="xueshengliuyan">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xueshengliuyan" label="学生留言" prop="xueshengliuyan">
                    <span v-html="ruleForm.xueshengliuyan"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="教师回复" prop="jiaoshihuifu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jiaoshihuifu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoshihuifu" label="教师回复" prop="jiaoshihuifu">
                    <span v-html="ruleForm.jiaoshihuifu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshengliuyan = true;
            continue;
	            	            ...
	            	            if(o=='jiaoshihuifu'){
            this.ruleForm.jiaoshihuifu = obj[o];
	    this.ro.jiaoshihuifu = true;
            continue;
          }
	            	            if(o=='userid'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shishengjiaoliu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shishengjiaoliuCrossAddOrUpdateFlag = false;
                  this.parent.search();
