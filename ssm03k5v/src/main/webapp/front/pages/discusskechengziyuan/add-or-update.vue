	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusskechengziyuan`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																				...
																																																																				if(this.ruleForm.id){
					await this.$api.update(`discusskechengziyuan`, this.ruleForm);
				}else{
					await this.$api.add(`discusskechengziyuan`, this.ruleForm);
				}
