...
public class DiscusskechengziyuanController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscusskechengziyuanEntity discusskechengziyuan, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscusskechengziyuanEntity discusskechengziyuan, HttpServletRequest request){
        EntityWrapper<DiscusskechengziyuanEntity> ew = new EntityWrapper<DiscusskechengziyuanEntity>();
		PageUtils page = discusskechengziyuanService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discusskechengziyuan), params), params));
        return R.ok().put("data", page);
    }
